...
import { updatePageTitle } from "../../utils/routeTitle";
 ...
 const verPhotoFootLeft4 = () => {
  ...
  const handleSaveImage = async () => {
   ...
   if (result?.id) {
        router.push("/takePhotoFoot/takePhotoFootRight1");
      }
    }
  }
  };
  ...
  return (
    ...
    <FooterActions onConfirm={handleSaveImage} retakePath="/takePhotoFoot/takePhotoFootLeft4" />
    
    </main>
  );
}

export default withAuth(verPhotoFootLeft4);
