...
const verPhotoFootRight3 = () => {
  ...
  const handleSaveImage = async () => {
    if (capturedImage && userId) {
      ...
      if (result?.id) {
        router.push("/takePhotoFoot/takePhotoFootRight4");
      }
    }
    }
  };
  ...
  return (
    <main className={styles.main}>
      ...
      <FooterActions
        ...
        retakePath="/takePhotoFoot/takePhotoFootRight3"
      />
    </main>
  );
};

export default withAuth(verPhotoFootRight3);
