...
const verPhotoFootRight2 = () => {
  ...
  const handleSaveImage = async () => {
    if (capturedImage && userId) {
      ...
      if (result?.id) {
        router.push("/takePhotoFoot/takePhotoFootRight3");
      }
    }
  }
  };
  ...
  return (
    <main className={styles.main}>
      ...
      <FooterActions
        ...
        retakePath="/takePhotoFoot/takePhotoFootRight2"
      />
    </main>
  );
};

export default withAuth(verPhotoFootRight2);
