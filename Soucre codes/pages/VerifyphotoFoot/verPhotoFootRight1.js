...
const verPhotoFootRight1 = () => {
  ...
  const handleSaveImage = async () => {
    if (capturedImage && userId) {
      ...
      if (result?.id) {
        router.push("/takePhotoFoot/takePhotoFootRight2");
      }
    }
  }
  };
  ...
  return (
    <main className={styles.main}>
      ...
      <FooterActions
        ...
        retakePath="/takePhotoFoot/takePhotoFootRight1"
      />
    </main>
  );
};

export default withAuth(verPhotoFootRight1);
